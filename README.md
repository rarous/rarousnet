...
get the app created:
    ...
    $ heroku apps:create rarousnet
    Creating rarousnet... done, stack is cedar
    http://rarousnet.herokuapp.com/ | git@heroku.com:rarousnet.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://rarousnet.herokuapp.com deployed to Heroku

    To git@heroku.com:rarousnet.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://rarousnet.herokuap.com
    ["Hello" :from Heroku]
